...
| `fixed/pressure-seed98.c` | pressure 98 | `-O1` did not compile until George's rule let coalescing shorten the live ranges around it. |
| `open/pressure-seed35.c` | pressure 35 | `-O1` does not compile: the capacity wall, reached by a different schedule. |
